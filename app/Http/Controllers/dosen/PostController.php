...
class PostController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dosen.berita.view',compact('post'));
    }
    ...
    public function create()
    {
        ...
        return view('dosen.berita.form', compact('category'));   
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('postdosen.index')->with('success', 'Created');
    }
    ...
    public function edit($id)
    {
        ...
        $category = Category::all();
        return view('dosen.berita.edit', compact('berita', 'category'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($berita->update($input)) {
            return redirect()->route('postdosen.index')->with('success', 'Edited');
        } 
    }
    ...
    {
        if(Post::destroy($id)){
            return redirect()->route('postdosen.index')->with('success', 'Deleted');
        }   
    }
}
