...
<div class="box box-default">
        ...
        <div class>
          ...
          <div class="row">
            ...
            <form action="{{ route('postdosen.store')}}" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label>Opsi</label>
                  <select name="status" class="form-control{{$errors->has('status') ? ' is-invalid' : '' }}" name="status" value="{{ old('status') }}" required>
                     ...
                     <option value="1" @if(old('status') == '1') selected="selected" @endif>Publish</option>
                     <option value="2" @if(old('status') == '2') selected="selected" @endif>Draft</option>
                  </select>
